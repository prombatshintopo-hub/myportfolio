    ...
    <section id="contact" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <motion.div
          ...
          className="rounded-[10px] border border-[var(--primary)]/26 bg-gradient-to-r from-[var(--primary)]/12 via-[var(--primary)]/6 to-transparent p-8 sm:p-10"
        >
          <p className="text-xs tracking-[0.2em] text-[var(--secondary)] uppercase">Contact</p>
          <h2 className="mt-4 max-w-3xl font-display text-4xl tracking-tight text-[var(--foreground)] sm:text-5xl">
          ...
          <a
            href={`mailto:${email}`}
            className="mt-7 inline-flex items-center rounded-md bg-[var(--primary)] px-8 py-4 text-sm font-medium text-[var(--foreground)] transition hover:bg-[var(--accent)]"
          >
            Start Conversation
          </a>
        </motion.div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a
            ...
            className="inline-flex items-center rounded-md border border-[var(--secondary)]/65 px-5 py-3 text-sm text-[var(--secondary)] transition hover:bg-[var(--secondary)]/15"
          >
            WhatsApp Chat
          </a>
          <a
            href={resumeUrl}
            className="inline-flex items-center gap-2 rounded-md border border-[var(--primary)]/40 px-5 py-3 text-sm text-[var(--foreground)]/92 transition hover:bg-[var(--primary)]/14"
          >
            Download CV
          ...
          {socialLinks.map((link, index) => (
            ...
            >
              ...
              <span>
                ...
                <span className="mt-1 block text-sm text-[var(--foreground)]">{link.value}</span>
              </span>
            </motion.a>
          ))}
        </div>
